    ...
    <header className="relative z-50 px-6 py-4 backdrop-blur-lg bg-background/80 border-b border-border">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <Button
            className="bg-gradient-to-r from-brand-400 to-brand-600 hover:from-brand-500 hover:to-brand-700 text-white font-semibold px-6 transition-all duration-300 hover:scale-105"
            asChild
          >
